...
export const RESOURCES: Record<string, ResourceDef> = {
  ...
  storyActs: {
    ...
    fields: [
      ...
      { name: 'loopMediaId', label: 'Scene clip', type: 'media', help: 'The camera move through this scene.' },
      { name: 'connectorMediaId', label: 'Connector out', type: 'media', help: 'The clip that flies from this scene into the next one.' },
      visibleField,
    ],
  },
};
